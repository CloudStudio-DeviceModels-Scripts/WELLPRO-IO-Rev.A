...
# Parsing + Configuration Script – WELLPRO-IO - Rev. A

This **Parsing + Configuration** script is designed for the **WELLPRO-IO** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – WELLPRO-IO Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **WELLPRO-IO** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
